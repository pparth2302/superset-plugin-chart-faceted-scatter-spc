  ...
  controlPanelSections: [{
    ...
    controlSetRows: [[{
      ...
      config: {
        ...
        default: '',
        renderTrigger: true,
        description: (0, _core.t)('Custom label applied to the x-axis in every facet panel.')
      }
    }, {
      name: 'y_axis_label',
      config: {
        ...
        default: '',
        renderTrigger: true,
        description: (0, _core.t)('Custom shared Y-axis label shown at the left of the facet grid.')
      }
    }], [{
      name: 'y_axis_label_gap',
      config: {
        type: 'TextControl',
        label: (0, _core.t)('Y-axis label gap'),
        default: 12,
        isInt: true,
        renderTrigger: true,
        description: (0, _core.t)('Space between Y-axis ticks/labels and the plot area.')
      }
    }, {
      name: 'x_axis_label_gap',
      config: {
        type: 'TextControl',
        label: (0, _core.t)('X-axis label gap'),
        default: 10,
        isInt: true,
        renderTrigger: true,
        description: (0, _core.t)('Space between X-axis ticks/labels and the plot area.')
      }
    }], [{
      name: 'facet_title_gap',
      config: {
        type: 'TextControl',
        label: (0, _core.t)('Facet title gap'),
        default: 12,
        isInt: true,
        renderTrigger: true,
        description: (0, _core.t)('Space between the facet title and the plot area.')
      }
    }, {
      name: 'panel_padding',
      config: {
        type: 'TextControl',
        label: (0, _core.t)('Panel padding'),
        default: 12,
        isInt: true,
        renderTrigger: true,
        description: (0, _core.t)('Internal padding used around each facet chart.')
      }
    }], [{
      name: 'left_outer_axis_padding',
      config: {
        type: 'TextControl',
        label: (0, _core.t)('Left outer axis padding'),
        default: 16,
        isInt: true,
        renderTrigger: true,
        description: (0, _core.t)('Extra left padding applied only to the first facet in each row before the visible Y-axis.')
      }
    }], [{
      name: 'overall_chart_height',
      config: {
        type: 'TextControl',
        label: (0, _core.t)('Overall chart height'),
        default: '',
        isInt: true,
        renderTrigger: true,
        description: (0, _core.t)('Optional total rendered chart height in pixels. If larger than the container, the chart scrolls vertically.')
      }
    }, {
      name: 'overall_chart_width',
      config: {
        type: 'TextControl',
        label: (0, _core.t)('Overall chart width'),
        default: '',
        isInt: true,
        renderTrigger: true,
        description: (0, _core.t)('Optional total rendered chart width in pixels. If larger than the container, the chart scrolls horizontally.')
      }
    }], [{
      name: 'row_gap',
      config: {
        type: 'TextControl',
        label: (0, _core.t)('Row gap'),
        default: 16,
        isInt: true,
        renderTrigger: true
      }
      ...
      config: {
        type: 'CheckboxControl',
        label: (0, _core.t)('Enable scroll wheel zoom'),
        default: true,
        renderTrigger: true
      }
    }, {
      ...
      config: {
        type: 'CheckboxControl',
        label: (0, _core.t)('Connect panels within row'),
        default: true,
        renderTrigger: true
      }
    }], [{
      ...
      config: {
        type: 'CheckboxControl',
        label: (0, _core.t)('Show data zoom slider'),
        default: true,
        renderTrigger: true
      }
    }, {
      ...
      config: {
        type: 'CheckboxControl',
        label: (0, _core.t)('Show data zoom detail text'),
        default: false,
        renderTrigger: true
      }
    }], [{
      ...
      config: {
        type: 'TextControl',
        label: (0, _core.t)('Data zoom gap'),
        default: 10,
        isInt: true,
        renderTrigger: true,
        description: (0, _core.t)('Space between the x-axis area and the data zoom slider.')
      }
    }], [{
      name: 'time_format',
      ...
      config: _extends({}, _chartControls.sharedControls.x_axis_time_format, {
        ...
        description: (0, _core.t)('Format applied to timestamp values in tooltips.')
      })
    }]]
  }, {
