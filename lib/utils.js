...
exports.getMetricLabelOrUndefined = getMetricLabelOrUndefined;
exports.parseOptionalNumber = parseOptionalNumber;
exports.parsePositiveInteger = parsePositiveInteger;
exports.stringifyFacetValue = stringifyFacetValue;
...
function parsePositiveInteger(value, fallback, _temp) {
  var {
    min = 1,
    max
  } = _temp === void 0 ? {} : _temp;
...
function getMetricLabelOrUndefined(metric) {
  var label = (0, _core.getMetricLabel)(metric);
